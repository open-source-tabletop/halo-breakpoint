...
| Unit Profile |      |
| :----------- | :--- |
| Configuration | A Spartan unit consists of 1 Spartan II or IV. |
| Equipment | A Spartan is equipped with an MA5 Assault Rifle, an M6 Pistol, M9 Grenades, and Melee Strike (6). A Spartan may replace its MA5 Assault Rifle with any of the following: |
| | M6 Pistol |
| | M90 Shotgun |
| | BR55 Service Rifle |
| | M7 SMG |
